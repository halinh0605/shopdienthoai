                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="category.html">OPPO</a></li>
                                    <li class="nav-item"><a class="nav-link" href="single-product.html">Iphone</a></li>
                                    <li class="nav-item"><a class="nav-link" href="checkout.html">Samsung</a></li>
                                    <li class="nav-item"><a class="nav-link" href="cart.html">Xiaomi</a></li>
                                    <li class="nav-item"><a class="nav-link" href="confirmation.html">Huawei</a></li>
                                </ul>
                            </li>

                            <li class="nav-item"><a class="nav-link" href="contact.html">Tin tức</a></li>
                    ...
                    <div class="active-banner-slider">
                        ...
                        <div class="row single-slide align-items-center d-flex">
                          ...
                          {{----}}
                                ...
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="item"><div class="banner-img">--}}
                                    {{--<img class="img-fluid" src="karma/img/banner/Banner3.png" width="1920px" alt="">--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8">
                            <div class="single-deal">
                                ...
                                <img class="img-fluid w-100" src="karma/img/category/c1.jpg" alt="">
                                <a href="karma/img/category/c1.jpg" class="img-pop-up" target="_blank">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-deal">
                                <div class="overlay"></div>
                                <img class="img-fluid w-100" src="karma/img/category/c2.jpg" alt="">
                                <a href="karma/img/category/c2.jpg" class="img-pop-up" target="_blank">
                                    <div class="deal-details">
                                        <h6 class="deal-title">Sneaker for Sports</h6>
                                    </div>
                                </a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-deal">
                                <div class="overlay"></div>
                                <img class="img-fluid w-100" src="karma/img/category/c3.jpg" alt="">
                                <a href="karma/img/category/c3.jpg" class="img-pop-up" target="_blank">
                                    <div class="deal-details">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="single-deal">
                                <div class="overlay"></div>
                                <img class="img-fluid w-100" src="karma/img/category/c4.jpg" alt="">
                                <a href="karma/img/category/c4.jpg" class="img-pop-up" target="_blank">
                                    <div class="deal-details">
                                        <h6 class="deal-title">Sneaker for Sports</h6>
                                    </div>
                                </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-deal">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="karma/img/category/c5.jpg" alt="">
                        <a href="karma/img/category/c5.jpg" class="img-pop-up" target="_blank">
                            <div class="deal-details">
                                <h6 class="deal-title">Sneaker for Sports</h6>
                            </div>
                        </a>
